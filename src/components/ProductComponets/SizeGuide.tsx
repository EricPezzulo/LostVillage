...
const SizeGuide: React.FC<SizeGuideProps> = ({
  ...
  return (
    <AnimatePresence>
      {showSizeGuide && (
        <motion.div
          className="fixed bottom-0 z-10 flex h-2/3 w-screen
          flex-col items-center  border-t-2 border-gray-700 bg-gray-100"
          initial={{ y: 600 }}
          animate={{ y: 0 }}
          exit={{ y: 600 }}
        ...
        >
          <div className="overflow-y-scroll">
            ...
            >
              ...
              <button
                className="absolute -top-7 right-3 rounded-full border-2 border-black bg-white p-2"
                type="button"
